...
HD_PWD='C:/Users/DELL/Desktop/digitalclock/Alpa_Testing/Alpa_Testing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tt_um_DigitalClockTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tt_um_DigitalClockTop.tcl
