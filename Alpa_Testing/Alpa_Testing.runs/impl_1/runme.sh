...
HD_PWD='C:/Users/DELL/Desktop/digitalclock/Alpa_Testing/Alpa_Testing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tt_um_DigitalClockTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tt_um_DigitalClockTop.tcl -notrace
